 ...
 * <p>用於接收更新供應商的請求資料。</p>
 *
 * <p>此 DTO 包含更新供應商所需的所有欄位，並使用 Bean Validation 進行資料驗證。</p>
 *
 * <p>與 {@link CreateSupplierRequest} 的差異：</p>
 * <ul>
 *   <li>更新時所有欄位都可以修改</li>
 *   <li>供應商代碼也可以更新（但需確保唯一性）</li>
 *   <li>驗證規則相同</li>
 * </ul>
 *
 * <p>驗證規則：</p>
 * <ul>
 *   <li>{@code @NotBlank} - 欄位不可為空白</li>
